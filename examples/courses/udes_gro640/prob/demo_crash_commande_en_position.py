...
# Contrôleur en position de l'effecteur s#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
Created on Fri May  1 19:51:49 2020
...
from pyro.control.robotcontrollers import EndEffectorKinematicController
from pyro.control.robotcontrollers import DampedLeastSquare_EndEffectorKinematicController
...
ctl = DampedLeastSquare_EndEffectorKinematicController( sys )
